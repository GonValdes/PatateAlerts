...
echo.
echo This will create a scheduled task that runs once per day at 7:00 PM (19:00).
echo.
...
echo   schtasks /create /tn "StockAlertMonitor" /tr "%PYTHON_CMD% \"%MAIN_SCRIPT%\"" /sc daily /st 19:00 /ru SYSTEM
echo.
